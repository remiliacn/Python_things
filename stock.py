...
from config import API_KEY_OKEX, API_SECRET_OKEX, API_PASSPHRASE_OKEX
...
class Crypto:
    ...
    def get_kline(self, analyze_type='MACD'):
        api_key = API_KEY_OKEX
        secret_key = API_SECRET_OKEX
        passphrase = API_PASSPHRASE_OKEX
...
class Stock:
    ...
    def get_kline_map(self, analyze_type='MACD') -> (str, str):
